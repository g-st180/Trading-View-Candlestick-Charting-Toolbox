...
export default function AvgTpChart() {
	...
	return (
		<div className="rounded-lg border border-cyan-500/20 bg-black/80 backdrop-blur-sm shadow-lg">
			<div className="px-4 pt-4 pb-3 h-[52px] flex items-start">
				<h3 className="metallic-title text-sm font-semibold uppercase tracking-wide leading-tight line-clamp-2">TP Compute Time (s)</h3>
			</div>
